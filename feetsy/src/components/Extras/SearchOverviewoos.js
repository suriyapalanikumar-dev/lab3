...
const SearchOverviewoos = () =>{
    ...
    <Select size="large" defaultValue="0" disabled>
    ...
    <h2>USD 300</h2>
    <Button type="primary" size="large" onClick={(e)=>alert("Quantity must be mentioned")}>Add to Cart</Button>
    <br/>
    <br/>
...
export default SearchOverviewoos
    ;